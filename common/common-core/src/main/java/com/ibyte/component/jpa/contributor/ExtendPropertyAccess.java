...
public class ExtendPropertyAccess implements PropertyAccess, MetaConstant {
	...
	public static class DynamicPropertyGetterSetter implements Getter, Setter {
		...
		public void set(Object target, Object value,
			...
			((IEntity) target).getExtendProps().put(propertyName, value);
		}

		@Override
		public Object get(Object owner) {
			return ((IEntity) owner).getExtendProps().get(propertyName);
		}
